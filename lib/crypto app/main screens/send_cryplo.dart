...
class SendCryplo extends StatefulWidget {
  const SendCryplo({super.key});

  @override
  State<SendCryplo> createState() => _SendCryploState();
}

class _SendCryploState extends State<SendCryplo>
              ...
              return Stack(
                children: [
                  ...
                  Positioned(
                    width: 300,
                    height: 300,
                    left: MediaQuery.of(context).size.width / 2 - 150, // Центрирование по горизонтали
                    top: MediaQuery.of(context).size.height / 4 - 100, // Расположение в верхней части
                    child: IgnorePointer(
                      child: Lottie.asset(
                        'assets/json/wallet_anim.json',
                        fit: BoxFit.contain,
                        repeat: true,
                        animate: true,
                      ),
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: SvgPicture.asset('assets/images/svg/qr_camera.svg'),
                ),
              ],
            ),
          ),
