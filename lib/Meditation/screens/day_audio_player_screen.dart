...
class DayAudioPlayerScreen extends StatefulWidget {
  const DayAudioPlayerScreen({
    super.key,
  });

  @override
  State<DayAudioPlayerScreen> createState() => _DayAudioPlayerScreenState();
}

class _DayAudioPlayerScreenState extends State<DayAudioPlayerScreen> with TickerProviderStateMixin {
  ui.Image? image;
  ui.Image? image2;
  ui.Image? image3;
  ui.Image? image4;
  ...
  void initState() {
    _load([
      'assets/images/png/ellipse.png',
      'assets/images/png/teardrop.png',
      'assets/images/png/teardrop2.png',
      'assets/images/png/ellipse2.png',
    ]);
    loadMusic();
  ...
  void _load(List<String> path) async {
    ...
    var bytes4 = await rootBundle.load(path[3]);
    ...
    image4 = await decodeImageFromList(bytes4.buffer.asUint8List());
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        backgroundColor: const Color.fromRGBO(250, 247, 242, 1),
        body: CustomPaint(
          painter: ImageInsideDayPlayer(
            context: context,
            image: image,
            image2: image2,
            image3: image3,
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: SizedBox(
                                  ...
                                  child: SvgPicture.asset(
                                      'assets/images/svg/day_replay_15.svg'),
                                ),
                              ),
                              InkWell(
                                highlightColor: Colors.transparent,
                              ...
                              InkWell(
                                ...
                                child: SizedBox(
                                    ...
                                    height: 40,
                                    child: SvgPicture.asset(
                                        'assets/images/svg/day_forward_15.svg'),),
                              ),
                              SizedBox(
                                width: getWidth(context, 0),
                              ),
                                  ...
                                  builder: (context, snapshot2) {
                                    ...
                                    return SizedBox(
                                      ...
                                      child: ProgressBar(
                                        ...
                                        progressBarColor:
                                            const Color.fromRGBO(63, 65, 78, 1),
